    ...
    >
      <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-r from-yellow-200 via-red-400 to-pink-400 lg:h-4/5 lg:w-4/5 lg:flex-row lg:rounded-3xl">
        <div className="flex h-full w-full flex-1 items-center justify-center">
          <div className="flex h-3/5 w-4/5 flex-row items-center justify-center overflow-hidden rounded-3xl border-2 border-black lg:h-4/5 lg:flex-col">
            ...
            <div className="box-border flex h-full w-full flex-1 flex-col items-center justify-center bg-gray-200 px-8 py-2 lg:rounded-b-3xl">
              <span className="text-base font-extrabold lg:m-2 lg:text-3xl">
                Cashhog Huddle
              </span>
              <span className="text-xs text-gray-700 lg:text-lg">
                Inspire, Participate, and Create With Your Fellow Cashhogs.
              </span>
              {letUserMint ? (
                <motion.button
                  className="m-1 box-border rounded-2xl bg-pink-300 p-2 text-xs lg:m-3 lg:w-4/5 lg:p-4 lg:text-base"
        ...
        <div className="flex h-full w-full flex-1 flex-col items-center justify-center">
          <div className="flex h-3/5 w-4/5 flex-col items-center justify-center rounded-3xl lg:h-4/5">
            <div className="flex h-full w-full flex-1 flex-col items-center justify-end rounded-3xl border-2 border-black bg-gray-300">
              <input
                className="box-border h-1/2 w-full rounded-t-3xl bg-gray-300 p-6 text-xl focus:outline-none lg:text-3xl"
                placeholder="Enter your email"
              />
              <div className="box-border flex h-1/2 w-full items-center justify-between p-4 text-sm lg:p-6 lg:text-base">
                <span>Signup for newsletter:</span>
                <motion.button
                  className="box-border rounded-3xl bg-pink-300 p-2 text-xs lg:p-5 lg:text-base"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  Sign Up
            ...
            <div className="box-border flex h-full w-full flex-1 flex-col items-center justify-center rounded-b-3xl px-8">
              <span className="m-2 p-6 text-xl font-extrabold lg:text-3xl">
                Follow Us
              </span>
              <div className="flex w-full flex-row items-center justify-between">
                <FaTwitterSquare className="h-auto w-9 lg:w-16" />
                <FaYoutube className="h-auto w-9 lg:w-16" />
                <FaInstagram className="h-auto w-9 lg:w-16" />
                <FaDiscord className="h-auto w-9 lg:w-16" />
              </div>
            </div>
          </div>
        </div>
